...
description: tail-story의 한국어 본문을 각국 언어(영어, 중국어 번체, 일본어)로 번역하여 tail-translated/{lang} 폴더에 저장하는 진입점
---
...
- 중국어 번체: `tail-translated/zh-tw/{스토리명}.md`
...
3. 출력 폴더(`tail-translated/en/`, `tail-translated/zh-tw/`, `tail-translated/jp/`)가 없으면 생성한다
4. **언어별로 story-translator 에이전트를 병렬 spawn한다** (3개 동시)
