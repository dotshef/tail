---
name: pdf-generator
description: tail-bookform의 최종본을 pdf-builder/build-pdf.py로 PDF 변환하여 tail-pdf/{lang}/{스토리명}.pdf에 저장한다. 책 형식 마크다운을 인쇄용 PDF로 내보낼 때 사용한다.
tools: Bash, Read
---
...
2. `pdf-builder/templates/book.html` + `pdf-builder/templates/book.css`로 HTML 렌더
